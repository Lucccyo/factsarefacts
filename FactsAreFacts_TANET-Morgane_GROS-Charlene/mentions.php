...
<html lang="fr">
    ...
    <meta charset="utf-8">
        ...
        <link rel="stylesheet" href="footerPage_style.css">
    ...
    ">
        <nav class="navbar">
            <ul class="navbar-nav">
                <li class="Logo">
                    <!-- menu deroulant permettant d'acceder au differents chapitres des mentions légales -->
                    <a class="nav-link" href="javascript:history.back()">
                        <img src="img/Facts are Facts.png" alt="Logo de Facts Are Facts">
                        <span class="link-text"></span>
                    </a>
                </li>

                <li class="nav-item">
                    <a href="mentions.php" class="nav-link">
                        <i class="fas fa-gavel"></i>
                        <span class="link-text">Mentions Légales</span>
                    </a>
                </li>
                <li class="nav-item">
                    <a href="mentions.php#securite" class="nav-link">
                        <i class="fas fa-shield-alt"></i>
                        <span class="link-text">Sécurité</span>
                    </a>
                </li>
                <li class="nav-item">
                    <a href="mentions.php#profil" class="nav-link">
                        <i class="fas fa-users"></i>
                        <span class="link-text">Profil</span>
                    </a>
                </li>
                <li class="nav-item">
                    <a href="mentions.php#spam" class="nav-link">
                        <i class="fas fa-envelope-open"></i>
                        <span class="link-text">Spam</span>
                    </a>
                </li>
                <li class="nav-item">
                    <a href="mentions.php#expertise" class="nav-link">
                        <i class="fas fa-check-circle"></i>
                        <span class="link-text">Expertise</span>
                    </a>
                </li>
                <li class="nav-item">
                    <a href="mentions.php#financement" class="nav-link">
                        <i class="fas fa-coins"></i>
                        <span class="link-text">Financement</span>
                    </a>
                </li>
                <li class="nav-item">
